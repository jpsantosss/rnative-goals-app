...
export default function App() { //The default export is the function 'App'
  ...
  function addGoalHandler(){ //Creating 'addGoalHandler' function to add a 'goal' into our 'CourseGoals'.
    setCourseGoals(//'setCourseGoals' is a function that update the 'currentCourseGoals' state. 
      ...
      (pets) => [...pets, new_pet] == [cat, cow, sheep, dog] */
      {text: enteredGoalText, id: Math.random().toString()} //Is the new object that represents the new goal. 'text: enteredGoalText' defines the text prop of the object with the value 'enteredGoalText'. 'id: Math.random().toString()' defines the id prop of the object with a single string value generated by 'Math.random().toString()', creating a unique id por each object.
    ]);
  }; 
